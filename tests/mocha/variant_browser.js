...
test.describe('Variant Browser ('+config.browser()+')', function() {
    ...
    test.it('search by Variant ID', function() { variantSearchBy(driver,'variantId') });
    test.it('search by Species', function() { variantSearchBy(driver,'species') });
    test.it('search by Gene', function() { variantSearchBy(driver,'gene') });
    test.it('search by Polyphen and Sift Filters', function() { variantFilterBy(driver,'polyPhenSift') });
    test.it('Annotation Tab', function() { variantBottomPanel(driver, 'annotation') });
    test.it('Files Tab', function() { variantBottomPanel(driver, 'files') });
    test.it('Genotypes Tab', function() { variantBottomPanel(driver, 'genotypes') });
    test.it('Population Statistics', function() { variantBottomPanel(driver, 'population') });
});

function variantSearchBy(driver, searchType){
...
function variantFilterBy(driver, filterType){
    if (filterType == 'polyPhenSift'){
...
function variantBottomPanel(driver, panel){
