...
var annotation_text = [
    {species: 'aaegypti_aaegl3', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl Genomes v{cacheVersion} geneset.', vep_version:82},
    {species: 'agambiae_agamp4', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl Genomes v{cacheVersion} geneset.', vep_version:78},
    {species: 'aminimus_1v1', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the VectorBase v{cacheVersion} geneset.', vep_version:87},
    {species: 'aquadriannulatus_quad4av1', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the VectorBase v{cacheVersion} geneset.', vep_version:82},
    {species: 'asinensis_v1', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the VectorBase v{cacheVersion} geneset.', vep_version:82},
    {species: 'astephensi_sda500v1', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the VectorBase v{cacheVersion} geneset.', vep_version:82},
    {species: 'athaliana_tair10', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl Genomes v{cacheVersion} geneset.', vep_version:87},
    {species: 'btaurus_umd31', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl v{cacheVersion} geneset.', vep_version:82},
    {species: 'chircus_10', text: '', vep_version:''},
    {species: 'csabaeus_chlsab11', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl v{cacheVersion} geneset.', vep_version:82},
    {species: 'hsapiens_grch37', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the full GENCODE Ensembl v{cacheVersion} geneset.', vep_version:78},
    {species: 'hsapiens_grch38', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the full GENCODE Ensembl v{cacheVersion} geneset.', vep_version:86},
    {species: 'hvulgare_030312v2', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl Plants v{cacheVersion} geneset.', vep_version:78},
    {species: 'mmusculus_grcm38', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl v{cacheVersion} geneset.', vep_version:82},
    {species: 'oaries_oarv31', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl v{cacheVersion} geneset.', vep_version:82},
    {species: 'osativa_irgsp10', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl Genomes v{cacheVersion} geneset.', vep_version:87},
    {species: 'sbicolor_sorbi1', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl Plants v{cacheVersion} geneset.', vep_version:78},
    {species: 'slycopersicum_sl240', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl Plants v{cacheVersion} geneset.', vep_version:78},
    {species: 'smansoni_23792v2', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl Genomes v{cacheVersion} geneset.', vep_version:82},
    {species: 'sratti_ed321v504', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl Genomes v{cacheVersion} geneset.', vep_version:82},
    {species: 'zmays_agpv3', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl Plants v{cacheVersion} geneset.', vep_version:78},
    {species: 'ggallus_galgal4', text: 'Variant Effect Predictor (VEP) v{vepVersion} annotation against the Ensembl v{cacheVersion} geneset.', vep_version:81}
];
