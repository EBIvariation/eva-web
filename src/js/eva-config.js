...
consequenceTypesColors = [
    ...
    {id: 'initiator_codon_variant',color:'#FF0000', impact: 'LOW'},
                ...
                children: [
                    {
                        ...
                        children: [
                            ...
                            {acc: 'SO:0001582', name: 'initiator_codon_variant', qtip: 'A codon variant that changes at least one base of the first codon of a transcript', leaf: true, checked: false, iconCls: 'no-icon', color: '#ff0000' },
...
var annotation_text = [
    ...
    {species: 'olatipes_hdrr', text: '', vep_version:''},
