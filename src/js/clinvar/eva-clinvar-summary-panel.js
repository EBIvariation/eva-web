...
//                        '</tr>',
                        ...
                        '</tr>',
                        '<tr>',
                             '<td class="header">Review status</td><td id="reviewStatus">{clinicalSignificance.reviewStatus}</td>',
                        '</tr>',
                        '<tr>',
                        ...
                        '</tr>',
                        '<tr>',
                            '<td class="header">Variation Type</td><td id="variationType">'+variation_type+'</td>',
                        '</tr>',
                        '<tr>',
