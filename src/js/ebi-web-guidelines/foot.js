...
(function includeScripts() {
    var requireScripts = ['//www.ebi.ac.uk/web_guidelines/js/cookiebanner.js', '//www.ebi.ac.uk/web_guidelines/js/foot.js', '//www.ebi.ac.uk/web_guidelines/js/script.js', '//www.ebi.ac.uk/web_guidelines/js/downtime.js?' + Math.round(new Date().getTime() / 3600000)];
