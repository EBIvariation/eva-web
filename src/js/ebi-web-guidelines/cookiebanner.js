...
(function cookieBanner() {
    ...
    function createBanner() {
        ...
        inner.innerHTML = "" + "  <div class='grid_4 alpha'>" + "  <h1>Cookies on EMBL-EBI website</h1>" + "  </div>" + "  <div class='grid_20 omega'>" + "  <p>This website uses cookies to store a small amount of information on your computer, as part of the functioning of the site. Cookies used for the operation of the site have already been set.</p>" + "  <p>To find out more about the cookies we use and how to delete them, see our <a href='//wwwdev.ebi.ac.uk/about/cookies'>Cookie</a> and <a href='//wwwdev.ebi.ac.uk/about/privacy'>Privacy</a> statements.</p>" + "  <p><a id='cookie-dismiss' href='#'>Dismiss this notice</a></p>" + "  </div>" + "";
